				...
				<div class="row">
					<div class="col-sm-12 col-md-6 col-lg-3">
						<div class="cont-wrap text-mid">
							...
							<p>Allow your students to maintain access to therapy throughout all their transitions.</p>
						</div>
					</div>
					...
					<div class="col-sm-12 col-md-6 col-lg-3">
						<div class="cont-wrap text-mid">
							...
							<p><strong>Face to face no matter the place</strong></p>
							<p>Meet your students where it is convenient for them.</p>
						</div>
					</div>
					...
					<div class="col-sm-12 col-md-6 col-lg-3">
						<div class="cont-wrap text-mid">
							<i class="fas fa-laptop"></i>
							<p><strong>Uniquely UNI</strong></p>
							<p>Get advice and training to provide the best therapy customized specially for your school.</p>
						</div>
					</div>
					...
					<div class="col-sm-12 col-md-6 col-lg-3">
						<div class="cont-wrap text-mid">
							...
							<p><strong>Secure and Encrypted</strong></p>
							<p>Maintain the highest standards of security with HIPAA compliant messaging, video conferencing, and file sharing.</p>
						</div>
					</div>
				</div>
			</div>
